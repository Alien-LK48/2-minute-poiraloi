...
var imagesofnote = ['1.jpg','2.jpg','3.jpg','4.jpg','5.jpg','6.jpg','7.jpg','8.jpg','9.jpg','10.jpg','11.jpg','12.jpg','13.jpg','14.jpg','15.jpg','16.jpg','17.jpg','18.jpg','19.jpg','20.jpg'];
...
function prevnf(){
	...
	return finalnotes.setAttribute('src', "meterials/eee/"+imagesofnote[i]);			 
}
...
function prevsf(){
	...
	i--;
    document.getElementById('page').innerHTML=`page ${i+1}`;
	return finalsuggus.setAttribute('src', "meterials/eee/"+imagesofsuggs[i]);		 
}
...
function prevnm(){
	...
	i--;
    document.getElementById('page').innerHTML=`page ${i+1}`;
	return midnotes.setAttribute('src', "meterials/eee/"+imgsofmidnotes[i]);			 
}
...
function prevsm(){
	...
	i--;
    document.getElementById('page').innerHTML=`page ${i+1}`;
	return midsug.setAttribute('src', "meterials/eee/"+imgsofmidsuggs[i]);		 
}

...
function prevnf(){
	...
	i--;
	return finalnotes.setAttribute('src', "meterials/cg/"+imagesofnote[i]);			 
}
...
function prevsf(){
	...
	i--;
	return finalsuggus.setAttribute('src', "meterials/cg/"+imagesofsuggs[i]);		 
}
...
function prevnm(){
	...
	i--;
	return midnotes.setAttribute('src', "meterials/cg/"+imgsofmidnotes[i]);			 
}
...
function prevsm(){
	...
	i--;
	return midsug.setAttribute('src', "meterials/cg/"+imgsofmidsuggs[i]);		 
}
